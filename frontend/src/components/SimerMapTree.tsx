...
const Branch=memo(function Branch({node,level=0,expanded,active,onToggle,onSelect,onFollowLink,onOpenContainer}:{node:ViewNode;level?:number;expanded:Set<number>;active:number|null;onToggle:(id:number)=>void;onSelect:(n:SimerTreeNode)=>void;onFollowLink:(n:SimerTreeNode)=>void;onOpenContainer:(n:SimerTreeNode)=>void}){
