...
import { AddOutlined, RemoveOutlined, AccountTreeOutlined, OpenInNewOutlined, UnfoldLessOutlined, CenterFocusStrongOutlined } from "@mui/icons-material";
...
const Branch=memo(function Branch({node,level=0,expanded,active,onToggle,onSelect,onFollowLink}:{node:ViewNode;level?:number;expanded:Set<number>;active:number|null;onToggle:(id:number)=>void;onSelect:(n:SimerTreeNode)=>void;onFollowLink:(n:SimerTreeNode)=>void}){
